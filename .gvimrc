...
"matching paren red
autocmd BufRead,BufNewFile,BufEnter * syn match parens /[(){}]/ | hi parens guifg=black ctermfg=white cterm=bold gui=bold
...
"Compilers
"
autocmd filetype cpp nnoremap <F5> :!clear && g++ -std=gnu++14 -Wall -Wextra -Wshadow -Wfloat-equal -Wconversion -Wshift-overflow=2 -Wduplicated-cond -D_GLIBCXX_DEBUG -D_GLIBCXX_DEBUG_PEDANTIC -D_FORTIFY_SOURCE=2 -fsanitize=signed-integer-overflow -fsanitize=bounds -O2 -DCONVICTION %
autocmd filetype cpp nnoremap <C-c> :!xterm -e "compile % 1; read"
...
nnoremap <leader>ad :let @+=expand("%:p")<CR>

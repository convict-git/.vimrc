...
autocmd filetype c,cpp nnoremap <F6> :!clear && clear && valgrind --leak-check=full --show-leak-kinds=all ./a.out
autocmd filetype c,cpp nnoremap <F7> :!clear && clear && gdb ./a.out

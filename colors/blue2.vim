...
hi Normal	  ctermfg=White ctermbg=Black guifg=#FFFFCC guibg=#000040
...
hi Comment    ctermfg=Gray ctermbg=Black guifg=#00A0FF guibg=#000090 gui=NONE
hi Constant	  ctermfg=White ctermbg=Black guifg=#0050EE guibg=#000040 gui=NONE
hi Identifier ctermfg=lightblue  ctermbg=Black guifg=#FFFFFF guibg=#000040 gui=NONE
hi Type		  ctermfg=lightblue  ctermbg=Black guifg=#5050FF guibg=#000040 gui=NONE
...
hi PreProc	  ctermfg=DarkCyan ctermbg=Black guifg=#00FF00 guibg=#000040 gui=BOLD
...
hi Directory  ctermfg=lightblue  ctermbg=DarkBlue guifg=#00A0F0 guibg=#000040
hi Visual	  ctermfg=Black ctermbg=lightblue     guifg=#5050FF guibg=#FFFFFF
...
hi StatusLineNC term=bold cterm=bold ctermfg=Gray  ctermbg=Blue      gui=bold guifg=#AAAAAA guibg=#0050EE
hi LineNr		 term=bold cterm=bold ctermfg=White ctermbg=DarkBlue  gui=bold guifg=#00A0FF guibg=#0050EE

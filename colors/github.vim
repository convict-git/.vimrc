...
hi Cursor   ctermfg=black ctermbg=15  guifg=#F8F8FF   guibg=#444454 cterm=bold
...
hi Title    ctermfg=160 guifg=#ef5939
...
hi WarningMsg ctermfg=160 guifg=#ef5939
...
if version >= 700
    ...
    hi MatchParen cterm=reverse ctermbg=252 guifg=#000000 guibg=#cdcdfd
...
hi DiffDelete ctermfg=252 ctermbg=196 guifg=#DDCCCC guibg=#FFDDDD gui=none    cterm=none
" }}}

" {{{ Syntax highlighting
hi Ignore   ctermfg=8 guifg=#808080
hi Identifier   ctermfg=31 guifg=#0086B3
hi PreProc  ctermfg=0 guifg=#030433 gui=bold cterm=bold
...
hi Function ctermfg=19 guifg=#990000 gui=bold cterm=bold,italic
hi Statement    ctermfg=0 guifg=#000000 gui=bold cterm=bold
hi Type     ctermfg=235 guifg=#445588 gui=bold   cterm=bold,italic
hi Number   ctermfg=darkblue guifg=#1C9898
hi Todo     ctermfg=15 ctermbg=88 guifg=#FFFFFF guibg=#990000 gui=bold cterm=bold,reverse
hi Special  ctermfg=black guifg=#159828 gui=bold   cterm=bold
hi Label        ctermfg=0 guifg=#000000 gui=bold    cterm=bold
hi StorageClass ctermfg=0 guifg=#000000 gui=bold    cterm=bold
hi Structure    ctermfg=236 guifg=#000000 gui=bold    cterm=bold
hi TypeDef      ctermfg=0 guifg=#000000 gui=bold    cterm=bold
hi Conditional ctermfg=235 cterm=bold gui=NONE guifg=#000000 guibg=NONE
hi Operator cterm=bold gui=bold guifg=#ff0000

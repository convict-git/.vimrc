hi clear
syntax reset
let g:colors_name = "mefar"
hi Normal ctermfg=White ctermbg=darkblue guifg=Aqua guibg=#000082
...
hi Type gui=NONE guifg=#00ffff gui=bold
hi Constant guifg=Magenta
hi Comment gui=italic guibg=NONE guifg=#a3a3a3 cterm=italic ctermfg=grey ctermbg=darkblue
hi Identifier gui=NONE guifg=#ffffff guibg=NONE gui=bold
